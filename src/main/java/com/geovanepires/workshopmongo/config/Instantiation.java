package com.geovanepires.workshopmongo.config;
...
import com.geovanepires.workshopmongo.dto.AuthorDTO;
import com.geovanepires.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu Viagem", "Vou para Sao Paulo, Abracos!", new AuthorDTO(maria));
